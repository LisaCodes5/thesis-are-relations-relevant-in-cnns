...
PICASSO_ROOT = os.path.join(DATASET_ROOT, 'picasso_dataset/FFA-data/left')   #Change: added Features Further Apart data folder
...
def generate_image(canvas: int, organ_mapping: Sequence[Sequence[str]]) -> np.ndarray:
    ...
    for om in organ_mapping:
        ...
        offset = 0																			#Change: move whole picture to the left
